...
svg.addEventListener('click', function(event) {
    ...
    state.size += 1;                            // THIS DOESN'T WORK CHECK TO SEE IF IT DOES FROM PANOPTO
...
function updateText(data) {
    ...
    text.innerHTML = `There are ${data.length} circles on this page and the average color is rgb(0, ${green}, ${blue})`;
